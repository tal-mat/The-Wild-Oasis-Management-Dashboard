...
export const cabins = [
  // Cabin 001: A cozy retreat for couples, featuring modern wood interiors and a private hot tub.
  {
    name: "001",
    maxCapacity: 2,
    regularPrice: 250,
  ...
  // Cabin 002: Ideal for couples seeking a romantic escape, with a hot tub and luxurious amenities.
  {
    name: "002",
    maxCapacity: 2,
    regularPrice: 350,
  ...
  // Cabin 003: A family-friendly cabin with modern amenities and a spacious deck for outdoor enjoyment.
  {
    name: "003",
    maxCapacity: 4,
    regularPrice: 300,
  ...
  // Cabin 004: Opulent interiors and a gourmet kitchen make this a perfect family vacation spot.
  {
    name: "004",
    maxCapacity: 4,
    regularPrice: 500,
  ...
  // Cabin 005: Spacious and cozy, perfect for larger groups to unwind and enjoy nature.
  {
    name: "005",
    maxCapacity: 6,
    regularPrice: 350,
  ...
  // Cabin 006: A lavish retreat with premium amenities, ideal for family gatherings.
  {
    name: "006",
    maxCapacity: 6,
    regularPrice: 800,
  ...
  // Cabin 007: Accommodates larger groups with multiple living areas and outdoor relaxation space.
  {
    name: "007",
    maxCapacity: 8,
    regularPrice: 600,
  ...
  // Cabin 008: The ultimate luxury destination for large groups, featuring high-end finishes and ample space.
  {
    name: "008",
    maxCapacity: 10,
    regularPrice: 1400,
